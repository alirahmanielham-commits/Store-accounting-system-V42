...
const badBlock = `const finalizeLogin = const refreshToken = jwt.sign({ username: user.username, tokenVersion }, JWT_REFRESH_SECRET, { expiresIn: '7d' });
...
authRoutes = authRoutes.replace(badBlock, goodBlock);
