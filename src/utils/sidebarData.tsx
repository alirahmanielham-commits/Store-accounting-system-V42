...
export const allSidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "online_pipe_pricing", label: "استعلام و ثبت آنلاین لوله گاز (سپاهان)", roles: ["admin", "accountant"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "unvouchered_financials", label: "عیب‌یابی اسناد فاقد سند", roles: ["admin", "accountant"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sms_messages", label: "مدیریت پیامک‌ها", roles: ["admin", "manager", "accountant"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "unvouchered_financials", label: "عملیات مالی فاقد سند", roles: ["admin", "accountant"] },
